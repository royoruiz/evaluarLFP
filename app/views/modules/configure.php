...
<ul class="nav nav-pills justify-content-between mb-4">
    <?php foreach ($steps as $index => $stepKey): ?>
        ...
        ?>
        <li class="nav-item flex-fill text-center small">
            <span class="d-block py-2 px-1 text-white <?= $badgeClass ?> rounded-pill mx-1">
                                ...
                                <table class="table table-sm align-middle">
                                    ...
                                    <tbody>
                                        <?php foreach ($criteriaList as $code => $details): ?>
                                            <?php
                                            $value = $oldWeights[$unitId][$code] ?? ($details['weight'] ?? 0);
                                            ?>
                                            <tr>
